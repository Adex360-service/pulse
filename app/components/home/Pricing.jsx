  ...
  return (
    <section id="contact" className="min-h-[510px] bg-[linear-gradient(110deg,#b9705d,#bd836c_43%,#986d91_76%,#856d92)] py-[120px] max-sm:min-h-[380px] max-sm:py-[55px]">
      <Container className="text-center">
        ...
        <a href="#" className="mt-[38px] inline-flex items-center justify-center rounded-[14px] bg-[#7a20fa] px-7 py-[17px] text-[13px] font-semibold text-white">See full pricing breakdown</a>
      </Container>
    </section>
  );
}
