...
export default function AnalyticsInsights() {
  return (
    <section className="bg-white pb-[100px] max-[700px]:pb-[60px]">
      <Container>
        <AnalyticsIntro
        ...
        <article className="mb-16 max-[700px]:mb-[35px]">
          <Visual
            asset={insights.main.asset}
            alt={insights.main.alt}
            className="object-contain"
          />
          <p className="pt-6 text-base leading-[1.55] text-[#55514f] max-[700px]:pt-[18px]">
