...
export default function ConsultationButton({ className = "" }) {
  return (
    <a href="#migration-contact" className={`loop-liquid-button inline-flex min-h-[64px] items-center justify-center gap-3 rounded-full bg-[linear-gradient(100deg,#9138ff,#2767ee)] px-8 text-[17px] font-semibold text-white shadow-[0_12px_30px_#6d35dc35] ${className}`}>
