...
export default function SubscriptionCta({ backgroundImage, sectionClassName, containerClassName, headingClassName, copyClassName, title = "Ready to scale your subscription business?", copy = "Join 2,400+ Shopify subscription brands on Pulse.", buttonLabel = "Talk to sales" }) {
