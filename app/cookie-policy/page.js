...
export const metadata = {
  title: "Pulse Cookie Policy",
  description:
    "Read Pulse's cookie policy covering how we use cookies, tracking technologies, and related settings on our website and services.",
};
