...
export const plans = [
  {
    name: "Starter",
    subtitle: "For brands launching subscriptions",
    price: "$99",
    rate: "1.0%",
  ...
  {
    name: "Pro",
    subtitle: "For brands scaling subscriptions",
    price: "$399",
    rate: "0.75%",
    action: "Book a demo",
    ...
    features: [
      "Dedicated CSM",
      "Surprise & delight flows",
      "Run targeted campaigns",
      "Prepaid & gifting",
      "Multi-language portal capability",
      "API & webhooks access",
    ],
  },
  {
    name: "Enterprise",
    subtitle: "For brands operating at scale",
    price: "Let's talk",
    rate: "Negotiable",
...
export const pricingFaqs = [
  ...
  "Does Pulse charge a per-order fee?",
  "Does Pulse charge setup fees, migration fees, or hidden charges?",
  "Does Pulse charge for add-ons or have hidden fees?",
  "What kind of support does Pulse offer?",
  "What will Pulse cost at my order volume?",
];
