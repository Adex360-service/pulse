...
export const demoLogos = [
  ["Mary Ruth's", `${cdn}/6a1749906a7f64a67377eea9_MaryRuth%27s.avif`],
  ["Beam", `${cdn}/695f59db3ac6ecfec3d98af1_beam%20logo.avif`],
  ["OSEA", `${cdn}/6a17421cacea3cfe4dc913d9_osea.webp`],
  ["Four Sigmatic", `${cdn}/6a17421971561e488b65c882_foursigmatic.webp`],
  ["Mammaly", `${cdn}/6a17421b8ad390acd7f4091f_mammly.webp`],
  ["Primal Queen", `${cdn}/6a33aa5ee4e426545c7b5f8a_image%20185%20(1).avif`],
  ["GoPure", `${cdn}/6a17498dd23a514e5a1a2466_GoPure.avif`],
];

export const demoBenefits = [
  {
    icon: `${cdn}/6a86f803606ecab8c2a7dad6_rocket-outline.avif`,
    title: "Built around your needs",
    copy: "Most Pulse features begin with requests from the merchants using it every day.",
  },
  {
...
export const demoReviews = [
  {
    logo: `${cdn}/6a174990f4063567cbd688dc_OSEA.avif`,
    quote:
      "We chose Pulse after an extensive evaluation. Its comprehensive feature set, seamless integrations, robust flows and hands-on support team ultimately won us over.",
  },
  {
    logo: `${cdn}/6a33aa5ee4e426545c7b5f8a_image%20185%20(1).avif`,
    quote:
      "Easily the best subscription app I've used. Their team is responsive and constantly helps us reduce churn and create a better customer experience.",
  },
  {
    logo: `${cdn}/6a17421971561e488b65c882_foursigmatic.webp`,
    quote:
      "Pulse has the features we need and an A+ support team. They listen to customer feedback and implement quickly.",
  },
  {
    logo: `${cdn}/6a17421b8ad390acd7f4091f_mammly.webp`,
    quote:
      "We chose Pulse because we were sure its features, especially churn prevention and upselling, would boost our subscription business.",
  },
  {
    logo: `${cdn}/6a17498cd23a514e5a1a23e0_Good%20Protein.avif`,
    quote:
      "By far the best subscription app. Their features are advanced and we have direct communication with a team that truly understands our goals.",
  },
  {
    logo: `${cdn}/695f59db3ac6ecfec3d98af1_beam%20logo.avif`,
    quote:
      "Pulse is easily the best subscription app in the Shopify ecosystem. The product keeps improving and the support is exceptional.",
  },
];
